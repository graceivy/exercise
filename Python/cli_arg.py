...
# Using custom terminologies: https://docs.aws.amazon.com/translate/latest/dg/using-ct.html
# Argparse: https://docs.python.org/3/library/argparse.html
# aws translate translate-text help
# To run it: python cli_arg.py --text "we are learning python on AWS" --source-language-code en --target-language-code fr --terminology-names "Amazon_Family"
